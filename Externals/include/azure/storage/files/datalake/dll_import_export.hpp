 ...
 */
    ...
    || (0 /**/ + 1 /**/)
#define AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL 1
#else
#define AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL 0
#endif

#if AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL
#if defined(_MSC_VER)
#if defined(AZ_STORAGE_FILES_DATALAKE_BEING_BUILT)
#define AZ_STORAGE_FILES_DATALAKE_DLLEXPORT __declspec(dllexport)
#else // !defined(AZ_STORAGE_FILES_DATALAKE_BEING_BUILT)
#define AZ_STORAGE_FILES_DATALAKE_DLLEXPORT __declspec(dllimport)
#endif // AZ_STORAGE_FILES_DATALAKE_BEING_BUILT
#else // !defined(_MSC_VER)
#define AZ_STORAGE_FILES_DATALAKE_DLLEXPORT
#endif // _MSC_VER
#else // !AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL
#define AZ_STORAGE_FILES_DATALAKE_DLLEXPORT
#endif // AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL

#undef AZ_STORAGE_FILES_DATALAKE_BUILT_AS_DLL
